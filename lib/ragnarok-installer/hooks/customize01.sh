...
# Commands to configure the base system.
# $Ragnarok: customize01.sh,v 1.5 2024/10/18 15:45:57 lecorbeau Exp $
...
chroot "$1" apt-get -o Apt::Install-Recommends="true" \
	-o Dpkg::Options::="--force-confdef" install ragnarok-base -y
